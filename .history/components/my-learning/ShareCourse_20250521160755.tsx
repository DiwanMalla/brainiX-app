...
export default function ShareCourse({ course, progress }: ShareCourseProps) {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      } lessons. Join me: https://braini-x-one.vercel.app/courses/${course.id}`;
      const result = await Share.share({
        message: shareMessage,
        url: `https://braini-x-one.vercel.app/courses/${course.id}`,
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <Text
            ...
            numberOfLines={1}
          >
            https://braini-x-one.vercel.app/courses/{course.id}
          </Text>
