...
const CourseLearningScreen = async () => {
...
const CourseLearningScreen = () => {
  ...
  const scrollRef = useRef<ScrollView>(null);
    ...
    // Define fetchCourseContent function
...
// setError is already defined as a state setter via useState, so this function is not needed.
// If you want to provide a fallback, you can do:
