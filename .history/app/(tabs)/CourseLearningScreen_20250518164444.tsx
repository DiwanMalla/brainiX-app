...
// import CourseHeader from "./CourseHeader"; // Assume adapted for React Native
// import VideoPlayer from "./VideoPlayer"; // Assume adapted for React Native with expo-av
import LessonContent from "@/components/my-learning/LessonContent"; // Assume adapted for React Native
// import CourseContentSidebar from "./CourseContentSidebar"; // Assume adapted for React Native
// // import CourseNotes from "./CourseNotes"; // Assume adapted for React Native
// import CourseDiscussion from "./CourseDiscussion"; // Assume adapted for React Native
import { Course, Lesson, Module, Note } from "@/types/my-learning"; // Reused types
...
export default function CourseLearningScreen() {
  ...
  const currentLesson = course.modules[activeModule]?.lessons[activeLesson];
  console.log("CourseLearningScreen: Current lesson", currentLesson);
