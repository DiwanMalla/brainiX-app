...
import {
  ...
  TabsList,
  TabsTrigger,
} from "@rnx-kit/react-native-tabs";
...
const styles = StyleSheet.create({
  ...
  moduleTitle: { fontSize: 16, fontWeight: "600", color: "#3b82f6" },
  lessonCard: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 10,
  ...
  lessonType: { fontSize: 12, color: "#6b7280", marginRight: 8 },
  lessonDuration: { fontSize: 12, color: "#6b7280" },
  errorText: { color: "#ef4444", fontSize: 16, fontWeight: "bold" },
  emptyText: { color: "#6b7280", fontSize: 16, fontStyle: "italic" },
});
