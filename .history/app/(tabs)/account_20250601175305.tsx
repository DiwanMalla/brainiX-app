...
const AccountScreen = () => {
  ...
  const handleAboutBrainiX = () => {
    // Placeholder: Navigate to About screen or open website
    Linking.openURL("https://braini-x-one.vercel.app");
    // Alternatively: navigation.navigate("About");
  };

  const handleHelpSupport = () => {
    Linking.openURL("https://braini-x-one.vercel.app/support");
  };
  ...
  const handleSignOut = async () => {
    try {
      await signOut();
      navigation.navigate("SignIn"); // Adjust to your sign-in screen
    } catch (error) {
