...
const ContentTabs = ({
  ...
  return <View style={styles.tabsContainer}>{renderLectures()}</View>;
};
...
const styles = StyleSheet.create({
  tabsContainer: {
    ...
    paddingTop: 10, // Space below ContentDisplay
  },
  tabContent: {
  ...
  moduleGap: {
    marginTop: 15, // Good gap between modules
  },
  moduleHeader: {
    flexDirection: "row",
    alignItems: "center",
  ...
  moduleTitle: {
    fontSize: 14, // Smaller size as requested
    color: "#fff",
    fontWeight: "500",
  },
  moduleLessonCount: {
